      ...
      if (h.creditHref && h.creditText) {
        ...
        h._creditLink && h.creditHref && h.creditText
          ? (h._creditLink.parentElement ||
              h._chartJsContainer.appendChild(h._creditLink),
            (h._creditLink.style.top = h.height - 14 + "px"))
          : h._creditLink.parentElement &&
            h._chartJsContainer.removeChild(h._creditLink);
      }
    }
  }
  function ta(h, p) {
  ...
  Na.Chart = (function() {
      ...
      if (
        ...
        this._selectedColorSet =
          "undefined" !== typeof Ba[this.colorSet]
            ? Ba[this.colorSet]
            : Ba.colorSet1;
        this._chartJsContainer = document.createElement("div");
        this._chartJsContainer.setAttribute(
          "class",
          "canvasjs-chart-container"
        );
        this._chartJsContainer.style.position = "relative";
        this._chartJsContainer.style.textAlign = "left";
        this._chartJsContainer.style.cursor = "auto";
        r || (this._chartJsContainer.style.height = "0px");
        this.container.appendChild(this._chartJsContainer);
        this.canvas = ta(c, e);
        ...
        this.canvas.getContext &&
          (this._chartJsContainer.appendChild(this.canvas),
          ...
          r
            ...
            : ((this.plotArea.canvas = ta(c, e)),
              ...
              this._chartJsContainer.appendChild(this.plotArea.canvas),
          ...
          this.overlaidCanvas.getContext &&
            (this._chartJsContainer.appendChild(this.overlaidCanvas),
          ...
          this._chartJsContainer.appendChild(this._toolBar),
        ...
        window.console &&
          window.console.log(
            'ChartJs Error: Chart Container with id "' +
              this._containerId +
              '" was not found'
          );
    }
    ...
    p.prototype.destroy = function() {
      ...
      for (
        ...
        this._chartJsContainer && this._chartJsContainer.hasChildNodes();

      )
        this._chartJsContainer.removeChild(this._chartJsContainer.lastChild);
      ...
      this.overlaidCanvas = this.canvas = this.container = this._chartJsContainer = null;
    ...
    p.prototype.print = function() {
      ...
      this._chartJsContainer.appendChild(d);
      var b = this,
      ...
      setTimeout(function() {
        ...
        c.print();
        setTimeout(function() {
          b._chartJsContainer.removeChild(d);
        }, 1e3);
      }, 500);
    };
    ...
    $.prototype._initialize = function() {
      if (this.enabled) {
        ...
        this.chart._chartJsContainer.appendChild(this.container);
      }
    };
