...
public class InvoiceConstant {
    ...
    private String DELIVERY_STATUS = "deliveryStatus";
    private String DRIVER_NAME = "driverName";
    private String VEHICLE_NO = "vehicleNo";
    private String CONTACT_NO = "contactNumber";
    private String ESTIMATED_DELIVERY_DATE_TIME = "estimatedDeliveryDateTime";
    ...
    private String QUANTITY_Q = "quanitity";
    private String QUANTITY = "quantity";
    private String IS_APPROVED = "isApproved";
    ...
    private String QUOTATION_STATUS = "quotationStatus";
